...
**Day 01: Personal Portfolio Page (HTML Only)**  
- A mini personal portfolio website.  
- Features semantic structure: `header`, `nav`, `main`, `section`, `article`, `footer`.  
- Includes internal navigation using anchor links.  
- Designed to show structured content with only HTML.  

Future projects will expand to include more complex layouts, interactive features, and eventually CSS and JavaScript enhancements.  
...
**Email:** fk3290867@gmail.com  
**Linkedin** www.linkedin.com/in/faiz-khan-79208539a
